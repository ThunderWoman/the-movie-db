...
const SearchMovies = () => {
    ...
    return (
        <div className={css.search}>
            ...
            <form>
                <input className={css.inputSearch} type="text" ref={inputSearchValue} placeholder="SearchMovies your interesting... "/>
                <button className={css.buttonSearch} onClick={searchValue}> <Link to="/search">SearchMovies</Link></button>
